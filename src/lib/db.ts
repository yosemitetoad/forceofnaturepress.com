  ...
  sections: [
    {
      ...
      fields: [
        ...
        { id: 'website', type: 'url', label: 'Website URL', placeholder: 'https://...', helpText: 'Please provide at least one of the following.', required: false, visible: true },
        { id: 'social', type: 'text', label: 'Social Media Handle(s)', placeholder: '@handle or profile link', helpText: '', required: false, visible: true },
        { id: 'business_address', type: 'text', label: 'Business / Store Address', placeholder: 'e.g. 123 Main St, Portland, OR 97201', helpText: '', required: false, visible: true },
